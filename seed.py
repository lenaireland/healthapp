...
def example_data():
    ...
    value_items = [
        ValueItem(value_date=datetime(2018, 10, 1, 0, 0, 0), value=80, user_value_id=1),
        ValueItem(value_date=datetime(2018, 10, 2, 0, 0, 0), value=60, user_value_id=1),
        ValueItem(value_date=datetime(2018, 10, 3, 0, 0, 0), value=45, user_value_id=1),
        ValueItem(value_date=datetime(2018, 10, 4, 0, 0, 0), value=40, user_value_id=1),
        ValueItem(value_date=datetime(2018, 10, 5, 0, 0, 0), value=70, user_value_id=1),
        ValueItem(value_date=datetime(2018, 10, 6, 0, 0, 0), value=110, user_value_id=1),
        ValueItem(value_date=datetime(2018, 10, 7, 0, 0, 0), value=180, user_value_id=1),
        ValueItem(value_date=datetime(2018, 10, 1, 0, 0, 0), value=30, user_value_id=2),
        ValueItem(value_date=datetime(2018, 10, 2, 0, 0, 0), value=60, user_value_id=2),
        ValueItem(value_date=datetime(2018, 10, 3, 0, 0, 0), value=90, user_value_id=2),
        ValueItem(value_date=datetime(2018, 10, 4, 0, 0, 0), value=110, user_value_id=2),
        ValueItem(value_date=datetime(2018, 10, 5, 0, 0, 0), value=60, user_value_id=2),
        ValueItem(value_date=datetime(2018, 10, 6, 0, 0, 0), value=30, user_value_id=2),
        ValueItem(value_date=datetime(2018, 10, 7, 0, 0, 0), value=80, user_value_id=2),
        ValueItem(value_date=datetime(2018, 10, 1, 0, 0, 0), value=70, user_value_id=3),
        ValueItem(value_date=datetime(2018, 10, 2, 0, 0, 0), value=110, user_value_id=3),
        ValueItem(value_date=datetime(2018, 10, 3, 0, 0, 0), value=160, user_value_id=3),
        ValueItem(value_date=datetime(2018, 10, 4, 0, 0, 0), value=170, user_value_id=3),
        ValueItem(value_date=datetime(2018, 10, 5, 0, 0, 0), value=100, user_value_id=3),
        ValueItem(value_date=datetime(2018, 10, 6, 0, 0, 0), value=60, user_value_id=3),
        ValueItem(value_date=datetime(2018, 10, 7, 0, 0, 0), value=30, user_value_id=3)        
    ]
    ...
    count_items = [
        CountItem(count_date=datetime(2018, 10, 7, 8, 30, 0), count=1, user_count_id=1),
        CountItem(count_date=datetime(2018, 10, 7, 21, 30, 0), count=1, user_count_id=1),
        CountItem(count_date=datetime(2018, 10, 7, 12, 30, 0), count=2, user_count_id=2),
        CountItem(count_date=datetime(2018, 10, 7, 7, 30, 0), count=1, user_count_id=3),
        CountItem(count_date=datetime(2018, 10, 7, 22, 30, 0), count=1, user_count_id=3),
        CountItem(count_date=datetime(2018, 10, 7, 8, 30, 0), count=2, user_count_id=4),
        CountItem(count_date=datetime(2018, 10, 7, 9, 1, 0), count=1, user_count_id=5),
        CountItem(count_date=datetime(2018, 10, 7, 22, 15, 0), count=1, user_count_id=5),
        CountItem(count_date=datetime(2018, 10, 7, 14, 30, 0), count=2, user_count_id=6),
    ]
